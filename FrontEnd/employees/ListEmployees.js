        ...
        <tbody>
            ...
            employees.map((employee, index) => (
                ...
                <td><NumericFormat value={employee.salary}
                    displayType='text' thousandSeparator=',' prefix='$' decimalScale={2} fixedDecimalScale/>
                </td>
                <td className='text-center'>
                    <div>
                        <Link to={`/edit/${employee.idEmployee}`} className='btn btn-warning btn-sm me-3'>Edit</Link>
